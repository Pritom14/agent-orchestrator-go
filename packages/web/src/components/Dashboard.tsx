    ...
    <div className="dashboard-shell flex h-screen">
            ...
            <div className="dashboard-hero__meta">
              <div className="flex items-center gap-3">
                ...
                >
                  Activity
                  <svg
                    className={`h-3 w-3 opacity-70 transition-transform ${activityPanelOpen ? "rotate-180" : ""}`}
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2"
                    viewBox="0 0 24 24"
      ...
      {activityPanelOpen && (
        <aside
          ...
          className="w-80 shrink-0 border-l border-[var(--color-border-subtle)] bg-[var(--color-bg-surface)] overflow-hidden flex flex-col"
