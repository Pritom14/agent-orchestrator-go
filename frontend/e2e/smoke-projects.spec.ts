...
test.skip("PRJ-001 add-project flow opens for a git repo path @T0 @PRJ", async ({ page }) => {
...
test.skip("PRJ-002 adding a project auto-spawns the orchestrator @T0 @PRJ", async ({ page }) => {
