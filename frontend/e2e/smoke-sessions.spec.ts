...
test("SES-001 create task/session from the board @T0 @SES", async ({ page }) => {
...
test("SES-003 fake-agent activity keeps the card in working/active @T0 @SES", async ({ page }) => {
...
test("SES-008 kill session drops it to a terminal state @T0 @SES", async ({ page }) => {
